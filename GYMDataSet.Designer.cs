...
namespace GymManagementSystem {
    ...
    public partial class GYMDataSet : global::System.Data.DataSet {
        ...
        public partial class tbl_userDataTable : global::System.Data.TypedTableBase<tbl_userRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tbl_userRow Addtbl_userRow(int id, string name, string phone, string gender, int age, string payment) {
        ...
        public partial class tbl_userRow : global::System.Data.DataRow {
            ...
            public int age {
                get {
                    return ((int)(this[this.tabletbl_user.ageColumn]));
                }
                set {
                    this[this.tabletbl_user.ageColumn] = value;
                }
            }
            ...
            public string payment {
                get {
                    try {
                        return ((string)(this[this.tabletbl_user.paymentColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'payment\' in table \'tbl_user\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletbl_user.paymentColumn] = value;
                }
            }
            ...
            public bool IspaymentNull() {
                return this.IsNull(this.tabletbl_user.paymentColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetpaymentNull() {
                this[this.tabletbl_user.paymentColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace GymManagementSystem.GYMDataSetTableAdapters {
    ...
    public partial class tbl_userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tbl_user] WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([phone] = @Original_phone) AND ([gender] = @Original_gender) AND ([age] = @Original_age) AND ((@IsNull_payment = 1 AND [payment] IS NULL) OR ([payment] = @Original_payment)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tbl_user] ([id], [name], [phone], [gender], [age], [payment]) " +
                "VALUES (@id, @name, @phone, @gender, @age, @payment);\r\nSELECT id, name, phone, g" +
                "ender, age, payment FROM tbl_user WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_user] SET [id] = @id, [name] = @name, [phone] = @phone, [gender] = @gender, [age] = @age, [payment] = @payment WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([phone] = @Original_phone) AND ([gender] = @Original_gender) AND ([age] = @Original_age) AND ((@IsNull_payment = 1 AND [payment] IS NULL) OR ([payment] = @Original_payment)));
SELECT id, name, phone, gender, age, payment FROM tbl_user WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, phone, gender, age, payment FROM dbo.tbl_user";
        ...
        public virtual int Fill(GYMDataSet.tbl_userDataTable dataTable) {
        ...
        public virtual GYMDataSet.tbl_userDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            GYMDataSet.tbl_userDataTable dataTable = new GYMDataSet.tbl_userDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(GYMDataSet.tbl_userDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_phone, string Original_gender, int Original_age, string Original_payment) {
        ...
        public virtual int Insert(int id, string name, string phone, string gender, int age, string payment) {
        ...
        public virtual int Update(int id, string name, string phone, string gender, int age, string payment, int Original_id, string Original_name, string Original_phone, string Original_gender, int Original_age, string Original_payment) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string phone, string gender, int age, string payment, int Original_id, string Original_name, string Original_phone, string Original_gender, int Original_age, string Original_payment) {
            return this.Update(Original_id, name, phone, gender, age, payment, Original_id, Original_name, Original_phone, Original_gender, Original_age, Original_payment);
        }
    }
